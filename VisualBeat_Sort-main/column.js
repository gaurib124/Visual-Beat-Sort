class Column {
    constructor(x, y, width, height) {
        ...
        this.queue = [];
        this.color = {
            r: 255, // Red component for yellow
            g: 255, // Green component for yellow
            b: 0    // Blue component for yellow
        };
    }
    ...
    moveTo(loc, yOffset = 1, frameCount = 20) {
        for (let i = 1; i <= frameCount; i++) {
            ...
            this.queue.push({
                ...
                r: lerp(255, 255, u), // Keep the red constant
                g: lerp(255, 255 * (1 - u), u), // Transition from yellow to orange
                b: lerp(0, 0, u) // Keep blue constant at 0
            });
        }
    }
